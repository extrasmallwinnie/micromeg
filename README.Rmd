...
4. Make a "metadata" file with pertinent information on the samples and controls in your run. [Jump to example -->](https://github.com/extrasmallwinnie/micromeg/?tab=readme-ov-file#metadata)
