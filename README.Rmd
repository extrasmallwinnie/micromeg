...
2. Location is missing for the participant that sample "HC1" was taken from. Let's say that the participant declined to share their geographic location, so that's why it's missing from our data. With real life data, it's pretty normal to have some information missing.    
