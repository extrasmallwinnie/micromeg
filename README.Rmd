...
5. Load in the ASV and taxonomy tables, and do some basic sanity checking on the metadata, ASV, and taxonomy objects. [Jump to example &darr;](https://github.com/extrasmallwinnie/micromeg/?tab=readme-ov-file#metadata).   
