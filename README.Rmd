...
This is the least "bad" warning. We got a warning that no column named "SampleID" was found in the ASV count table. You don't *have* to follow this convention, but to use this package, it will make things much easier. 

We got the prompt to run checkSampleID() on badasv1, so let's do that:

```{r badcheck1, eval=FALSE}
